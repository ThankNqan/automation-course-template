...
public class HomePageIvivu extends BasePage {
    ...
    By startDateFieldLocator = By.xpath("//button[@class='col-span-5 ds__btn-left']");
    By endDateFieldLocator = By.xpath("//button[@class='col-span-5 ds__btn-right']");
    By datePickerLocator = By.xpath("//div[@class='litepicker']//div[@class='month-item']");
    ...
    public void selectDate(String expetecdDay, String expectedMonth, String expectedYear) {
        ...
        for (int i = 0; i < dateItems.size(); i++) {
            ...
            String currentMonth = item.findElement(By.xpath("//strong[@class='month-item-name']")).getText();
        ...
        By expectedDayLocator = By.xpath("//div[@class='container__days']//div[text()='" + expetecdDay + "']");
